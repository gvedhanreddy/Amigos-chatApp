...
// This function will be used in the chat application to handle the message Forms
...
//This function is used to Save the time stamp of the message date,month,year
    ...
    // For handling the scrolling in the Application message form
    ...
    //To Timestamp the message that user has sent
    ...
    // To create and handle a form containing Message sending box and the button so to user click on it to send the message
    //Also to fetch the private user profile pic and the chat history
    return (
        <>
